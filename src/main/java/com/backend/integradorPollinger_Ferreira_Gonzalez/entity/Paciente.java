package com.backend.integradorPollinger_Ferreira_Gonzalez.entity;
...
public class Paciente {
    ...
    private String dni; //cambiar a Long
    //datos numericos notblank, pattern, size son incompatible
